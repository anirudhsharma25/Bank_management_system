...
void login(void);
void signup(void);
void accounttype(char name[50]); void Loan(char name[50]);
void Savings(char name[50]); void logout(void);
int main() {
int l_sp;
...
printf("\n\t\tType P for personal loan type\n\t\tType E for educational loan type\n");
    ...
    if(loantype[0] == 'P')//personal
    {
        ...
        if(name[0] == 'p')
        {
printf("You are eligible for the personal loan upto }
50000\n");
...
printf("You are not eligible for the Education loan\n"); }
        if(name[0] == 'v')
        {
printf("You are eligible for the Education loan upto
50000\n"); }
else {
printf("Please contact branch manager for your loan approval\n");
} }
